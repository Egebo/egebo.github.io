...
translations_str = '''const translations = {
  tr: {
    ...
    about_intro: "Geliştirme serüvenim boyunca <strong>React Native</strong> ile uçtan uca modern projeler geliştiriyor, Google Play'de binlerce kullanıcıya ulaştırıyorum. Mobil dünyada performanslı, kullanıcı dostu ve estetik uygulamalar geliştirmek benim temel uzmanlık alanım.",
  ...
  en: {
    ...
    about_intro: "Throughout my development journey, I have developed end-to-end modern projects with <strong>React Native</strong> and delivered them to thousands of users on Google Play. Building performant, user-friendly, and aesthetic applications in the mobile world is my core expertise.",
...
new_text = re.sub(r'const translations = \{.*?\n\};', translations_str, js_text, flags=re.DOTALL)

with open(js_file, 'w', encoding='utf-8') as f:
    f.write(new_text)

print("Restored translations block.")
