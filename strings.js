...
window.I18N = {
  tr: {
    ...
    "ach.1.desc": "Romanya, 2022. Egemen, 4 kişilik bir takımda hazır bir drone için Python ile otonom kontrol yazılımı geliştirdi. Yazılım, iki direk arasındaki çizgiyi takip ederek dünya birinciliğini getirdi.",
    "ach.2.rank": "Türkiye 2.'si",
    "ach.2.title": "Teknofest İHA Yarışması",
    "ach.2.desc": "Teknofest İHA yarışmasında Egemen, yaklaşık 10 kişilik takımın koordinasyonunu ve otonom uçuş kontrol yazılımını üstlendi. Takım Türkiye genelinde 2. oldu.",
    "ach.3.rank": "Türkiye 3.'sü",
    "ach.3.title": "TÜBİTAK: Akıllı Çocuk Kilidi",
    "ach.3.desc": "Bir arkadaşıyla geliştirdiği TÜBİTAK 2204 projesinde, arkaya bakan bir kamera arka koltukta gerçekten çocuk olup olmadığını tespit ediyor, sadece ilgili kapıyı kilitliyordu. Proje Türkiye 3.'sü oldu.",
  ...
  en: {
    ...
    "ach.1.title": "RoboChallenge AirRace",
    "ach.1.desc": "Romania, 2022. As part of a four-person team, Egemen built the Python-based autonomous control software for an off-the-shelf drone. The software tracked the line between two poles, taking first place in the world.",
    "ach.2.rank": "Turkey 2nd",
    "ach.2.title": "Teknofest UAV Competition",
    "ach.2.desc": "At the Teknofest UAV competition, Egemen coordinated a team of about ten people and owned the autonomous flight control software. The team placed 2nd nationally.",
    "ach.3.rank": "Turkey 3rd",
    "ach.3.title": "TÜBİTAK: Smart Child Lock",
    "ach.3.desc": "For a TÜBİTAK 2204 project built with a friend, a rear-facing camera detected whether a child was actually present in the back seat, locking only the relevant door. The project placed 3rd nationally.",
