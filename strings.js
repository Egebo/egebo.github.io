...
window.I18N = {
  tr: {
    ...
    "ach.1.desc": "Romanya, 2022. 4 kişilik bir takımla, hazır bir drone için Python ile otonom kontrol yazılımı geliştirilmiştir. Yazılım, iki direk arasındaki çizgiyi takip ederek dünya birinciliğini getirmiştir.",
  ...
  en: {
    ...
    "ach.1.title": "RoboChallenge AirRace",
    "ach.1.desc": "Romania, 2022. A Python-based autonomous control system was built for an off-the-shelf drone by a four-person team. It tracked the line between two poles, taking first place in the world.",
