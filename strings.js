...
window.I18N = {
  tr: {
    ...
    "proj.1.desc": "Eğitime özelleştirilmiş RAG tabanlı akademik danışman. Intent-routing motoru her sorguyu SQL, vektör arama veya web taramasına yönlendirir. GPT-4o-mini, ChromaDB, LangChain. Bitirme projem.",
    "proj.1.type": "Python · RAG",
    "proj.2.name": "Poco Loco",
    "proj.2.desc": "Butik bir çanta markası için sıfırdan geliştirdiğim, iyzico ile canlı ödeme alan uçtan uca bir e-ticaret sitesi. Ürün kataloğu, sipariş/kargo takibi ve bir yönetim paneli içeriyor.",
  ...
  en: {
    ...
    "proj.featured.f4.title": "Bilingual & Themes",
    "proj.featured.f4.desc": "Full interface and AI responses in Turkish/English. Light & dark mode in terracotta-sage-champagne palette.",
    "proj.live": "Live",
    "proj.status.progress": "In progress",
    "proj.status.done": "Completed",

    "proj.1.name": "AkademikChatbot",
    "proj.1.desc": "RAG-based academic advisor specialized for education. An intent-routing engine directs each query to SQL, vector search, or web crawling. GPT-4o-mini, ChromaDB, LangChain. My graduation project.",
    "proj.1.type": "Python · RAG",
    "proj.2.name": "Poco Loco",
    "proj.2.desc": "A full e-commerce site I built from scratch for a boutique bag brand, with live payments via iyzico. Product catalog, order/shipping tracking, and an admin panel.",
