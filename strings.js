...
window.I18N = {
  tr: {
    ...
    "path.4.kind": "Staj",
    "path.4.role": "Müşteri Paneli Mobil Uygulaması",
    "path.4.org": "Argede Bilişim Sistemleri",
    "path.4.when": "2026 / Şimdi",
    "path.4.desc": "Halihazırda çalışan bir web müşteri panelinin mobil uygulamasını geliştirdim; şu an yeni görev bekliyorum.",
    "path.5.kind": "Staj",
    "path.5.role": "Online Randevu Sistemi",
    "path.5.org": "Smart Software",
    "path.5.when": "2024",
    "path.5.desc": "Şirket için uçtan uca bir online randevu sistemi geliştirdim.",
    "path.3.kind": "Yarışma",
    ...
    "form.name.ph": "Adın Soyadın",
    "form.email.ph": "ornek@eposta.com",
  ...
  en: {
    ...
    "path.4.kind": "Internship",
    "path.4.role": "Customer Panel Mobile App",
    "path.4.org": "Argede Bilişim Sistemleri",
    "path.4.when": "2026 / Now",
    "path.4.desc": "Built the mobile counterpart of an existing web-based customer panel; currently awaiting my next task.",
    "path.5.kind": "Internship",
    "path.5.role": "Online Appointment System",
    "path.5.org": "Smart Software",
    "path.5.when": "2024",
    "path.5.desc": "Built an end-to-end online appointment booking system for the company.",
