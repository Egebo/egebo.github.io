...
const translations = {
  tr: {
    ...
    hero_subtitle: "React Native ile Google Play'de 4+ uygulama geliştirdim. Hem üniversitede okuyorum hem de freelance projeler yapıyorum — kullanıcılar için iyi hissettiren şeyler çıkarmak en büyük motivasyonum. 📱",
    ...
    about_title: "Biraz Kendimden",
    about_intro: "<strong>React Native</strong> ile şimdiye kadar 4 uygulama geliştirip Google Play'de yayınladım. Her projede bir öncekinden daha iyi bir şey öğrendim ve kullanıcı deneyimine takıntılı hale geldim — iyi görünen uygulama kullanılır.",
    about_body: "Üniversitede drone yarışmalarıyla başladım; Romanya'da <strong>dünya birincisi</strong> olduk, TÜBİTAK'ta dereceler geldik. Sonunda mobil tarafa geçtim çünkü burada hem kod yazıyorsun hem de insanların eline bir şey geçiyor.",
    info_uni: "Üniversite",
    ...
    skills_desc: "React Native ağırlıklı, zaman zaman AI tarafına da atlıyorum",
    ...
    p7_footer: "TÜBİTAK",
    p8_title: "Teknofest Ulaşımda Yapay Zeka",
    ...
    contact_title: "Yazın Bana",
    contact_desc: "Bir fikrin varsa, bir projen varsa ya da sadece merhaba demek istiyorsan — yaz.",
  ...
  en: {
    ...
    hero_subtitle: "I've shipped 4+ React Native apps to Google Play. Currently studying Computer Engineering while doing freelance work — I build things that feel good to use. 📱",
    ...
    about_intro: "I've built and shipped 4 apps to Google Play with <strong>React Native</strong>. Each project taught me something new and I got pretty obsessive about UX — apps that feel good get used.",
    about_body: "Started with drone competitions in uni — won <strong>1st place in the world</strong> in Romania, picked up TÜBİTAK awards too. Eventually shifted to mobile because here you write code AND people actually hold the result in their hands.",
    info_uni: "University",
    ...
    skills_desc: "React Native-heavy, with occasional detours into AI",
    ...
    p7_status: "Completed",
    p7_footer: "TÜBİTAK",
    p8_title: "Teknofest Transportation AI",
    ...
    contact_title: "Drop Me a Line",
    contact_desc: "Got an idea, a project, or just want to say hi — write me.",
    contact_email: "Email",
